export const STYLIST_SYSTEM_PROMPT = `You are ARIA — the AI fashion stylist powering TryOnX, the world's most advanced AI fashion platform.
...
export const FASHION_ANALYSIS_PROMPT = `Analyze this fashion item or outfit image and provide:
...
export const OUTFIT_SUGGESTION_PROMPT = `Based on the user's wardrobe items and the requested occasion, create 3 distinct outfit combinations. For each outfit:
