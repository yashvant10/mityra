...
import torch
# Enable Memory-Efficient SDP for faster inference on Tesla T4
...
def submit_function(
    ...
    # DEBUG: save the REAL automatically generated mask
    mask.save("/home/ubuntu/CatVTON/debug_automask.png")

    mask = mask_processor.blur(mask, blur_factor=3)
